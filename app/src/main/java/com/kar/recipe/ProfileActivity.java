...
public class ProfileActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView = (AutoCompleteTextView) findViewById(R.id.email_profile);
        populateAutoComplete();

        mPasswordView = (EditText) findViewById(R.id.password_profile);
        ...
        mPasswordResetView = (EditText) findViewById(R.id.password_reset_profile);
        ...
        Button mChangeLoginButton = (Button) findViewById(R.id.change_login_profile);
        ...
        Button mChangeAvatarButton = (Button) findViewById(R.id.change_avatar);
        mChangeAvatarButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                attemptChangeAvatar();
            }
        ...
        Button mChangePasswordButton = (Button) findViewById(R.id.change_password_profile);
    ...
    @RequiresApi(api = Build.VERSION_CODES.N)
    private void attemptChangeLogin() throws IOException {
        if (mAuthTask != null) {
            return;
        }
        ...
        if (TextUtils.isEmpty(login)) {
            ...
            cancel = true;
        } else if (DBHandler.getData().getUsers().findFirst(user -> user.getName().equals(login)) != null) {
    ...
    private void attemptChangeAvatar(){
